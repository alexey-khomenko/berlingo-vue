    ...
    <section class="modal modal_test modal_finish" data-modal-name="test_6" data-modal-important="on">
        <div class="modal__body-0">
            <div class="modal__body-1">
                <div class="back">
                    <img class="image_lg" alt="" src="../assets/images/modal-test-6-lg.png">
                    <img class="image_md" alt="" src="../assets/images/modal-test-6-md.png">
                    <img class="image_sm" alt="" src="../assets/images/modal-test-6-sm.png">
                </div>
                            ...
                            <template v-for="pen in result.pens" :key="pen.number">
                                <div class="pen" :data-slider="pen.number" data-hidden="off">
                                    <a class="pen__link" :href="pen.link">
                                        <img class="pen__image" alt="" :src="pen.image">
                                    </a>
